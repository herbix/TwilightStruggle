...
object Lang {
  ...
  addCardInfo("杜鲁门主义*", "移除苏联在欧洲1个未控制国家的所有影响力。")
  addCardInfo("奥林匹克运动会",
  ...
  addCardInfo("去斯大林化*", "苏联可以重新配置最多4点影响力到非美国控制的国家，同一国家最多放置2点影响力。")
  ...
  addCardInfo("困境*",
    "在下个行动轮开始时，美国玩家必须弃一张2或以上行动力的牌，然后掷骰，" +
  ...
  addCardInfo("捕熊陷阱*",
    "在下个行动轮开始时，苏联玩家必须弃一张2或以上行动力的牌，然后掷骰，" +
    "若是1~4则取消此牌效果，否则以后的行动轮也须重复以上行动。" +
  ...
  addCardInfo("军人集团",
    ...
    "你可以使用此牌的行动力在中美洲或南美洲发动一次免费政变或调整阵营。"
  )
  ...
  addCardInfo("向苏联出售谷物", "美国玩家从苏联玩家手牌中随机选一张牌，打出或归还。若无手牌或归还，则使用本牌进行行动。")
  ...
  addCardInfo("“一小步……”", "如果你太空竞赛落后，则太空竞赛前进2格，你只得第2格的VP。")
  addCardInfo("南美计分",
    "存在: 2\n" +
    "支配: 5\n" +
    "控制: 6\n" +
  ...
  addCardInfo("战争游戏*", "如果核战等级为2，你可以给对方6VP后，不经过终局计分，直接结束游戏。")
  addCardInfo("团结工会*",
